...
public class LineServiceImpl implements LineService {
     ...
     */
    @Override
    public String getLinePath(String data, String dir) {
    ...
    private String convertJson(String data) {
        ...
        try {
            ...
            List<Map<String, Object>> coordsList = new LinkedList<>();
            ...
            for (Object feature : features) {
                ...
                map.put("coords", JSON.parseArray(coordinates));
                coordsList.add(map);
            }
    ...
    private List<Map<String, Object>> getSeriesMap(List<Map<String, Object>> coordsList) {
        ...
        colorMap.put("width", 2);
        seriesMap.put("lineStyle", colorMap);
